...
def start(update, context):
    ...
    buttons.buildbutton("Channel", "https://t.me/HMMODS_OFFICIAL")
    buttons.buildbutton("Channel", "https://t.me/HMDRIVE_OFFICIAL")
    reply_markup = InlineKeyboardMarkup(buttons.build_menu(2))
    if CustomFilters.authorized_user(update) or CustomFilters.authorized_chat(update):
        start_string = f'''
This bot can mirror all your links to Google Drive!
CREATED BY @HMMODS_OFFICIAL
'''
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='HM DRIVE',
        author_name='HMDRIVE_OFFICIAL',
        author_url='https://t.me/HMDRIVE_OFFICIAL',
